Write a function `double_n-th(str,n)` that when given a string and an integer n, returns a new string where every n-th character in the original string is doubled based on the following conditions:
